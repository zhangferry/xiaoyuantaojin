...
-(void)getMyID
{
    ...
    NSDictionary *myDic = [NSDictionary dictionaryWithContentsOfFile:path2];
...
-(void)creatView
{
    ...
    [personImage setImage:[UIImage imageNamed:@"userDefault"] forState:UIControlStateNormal];
...

{
    ...
    if ([type isEqualToString:@"public.image"])
    {
        ...
        [personImage setImage:image forState:UIControlStateNormal];
